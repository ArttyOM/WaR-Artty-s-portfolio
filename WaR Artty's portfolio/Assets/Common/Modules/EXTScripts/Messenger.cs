...
static internal class MessengerInternal {
    ...
    //Artty: по заказу Vit-а сменил Default_Mode на "Не требовать"
	...
	static public T[] GetInvocationList<T>(string eventType) {
		...
		if(eventTable.TryGetValue(eventType, out d)) {//если eventType найден в справочнике событий eventTable, записываем в делегат d само событие, возвращаем его как очередной член массива делегатов
			try {
...
/// <summary>
/// отдельный словарь делегатов и методы к нему для случаев, когда требуется передавать в параметры делегата также и ссылку на ивент
/// </summary>
static internal class MessengerInternalSpecial
{
    readonly public static Dictionary<string, Delegate> eventTable = new Dictionary<string, Delegate>();
    //Artty: по заказу Vit-а сменил Default_Mode на "Не требовать"
    static public readonly MessengerMode DEFAULT_MODE = MessengerMode.DONT_REQUIRE_LISTENER;/*MessengerMode.REQUIRE_LISTENER;*/
    ...
    static public void OnBroadcasting(string eventType, MessengerMode mode)
    {
        if (mode == MessengerMode.REQUIRE_LISTENER && !eventTable.ContainsKey(eventType))
        {
            throw new MessengerInternalSpecial.BroadcastException(string.Format("Broadcasting message {0} but no listener found.", eventType));
        }
    }
...
static public class Messenger {
    ...
    #region специальный листенер (c самоидентификацией)

    static public void AddListener(string eventType, Action<string> handler)
    {
        MessengerInternalSpecial.AddListener(eventType, handler);
    }
    static public void AddListener<TReturn>(string eventType, Func<string, TReturn> handler)
    {
        MessengerInternalSpecial.AddListener(eventType, handler);
    }
    ...
    #endregion специальный листенер (c самоидентификацией)
...
static public class Messenger<T> {
    ...
    static public void AddListener(string eventType, Action<T, string> handler)
    {
        MessengerInternalSpecial.AddListener(eventType, handler);
    }
    static public void AddListener<TReturn>(string eventType, Func<T, string, TReturn> handler)
    {
        MessengerInternalSpecial.AddListener(eventType, handler);
    }
    static public void RemoveListener(string eventType, Action<T, string> handler)
    {
        MessengerInternalSpecial.RemoveListener(eventType, handler);
    }
    static public void RemoveListener<TReturn>(string eventType, Func<T, string, TReturn> handler)
    {
        MessengerInternalSpecial.RemoveListener(eventType, handler);
    }
    #endregion специальный листенер (c самоидентификацией)
	...
	static public void Broadcast(string eventType, T arg1, MessengerMode mode) {
        ...
        MessengerInternalSpecial.OnBroadcasting(eventType, mode);
        var invocationList2 = MessengerInternalSpecial.GetInvocationList<Action<T, string>>(eventType);
        if (invocationList2 != null)//фиксы от Арти
            foreach (var callback in invocationList2)
                callback.Invoke(arg1, eventType);
	...
	static public void Broadcast<TReturn>(string eventType, T arg1, Action<TReturn> returnCall, MessengerMode mode) {
        ...
        MessengerInternalSpecial.OnBroadcasting(eventType, mode);
        var invocationList2 = MessengerInternalSpecial.GetInvocationList<Func<T, string, TReturn>>(eventType);
        if (invocationList2 != null)//фиксы от Арти
            foreach (var result in invocationList2.Select(del => del.Invoke(arg1, eventType)).Cast<TReturn>())
            {
                returnCall.Invoke(result);
            }
    }
...
static public class Messenger<T, U> {
    ...
    static public void AddListener(string eventType, Action<T, U, string> handler)
    {
        MessengerInternalSpecial.AddListener(eventType, handler);
    }
    static public void AddListener<TReturn>(string eventType, Func<T, U, string,TReturn> handler)
    {
        MessengerInternalSpecial.AddListener(eventType, handler);
    }
    static public void RemoveListener(string eventType, Action<T, U, string> handler)
    {
        MessengerInternalSpecial.RemoveListener(eventType, handler);
    }
    static public void RemoveListener<TReturn>(string eventType, Func<T, U, string, TReturn> handler)
    {
        MessengerInternalSpecial.RemoveListener(eventType, handler);
    }
    #endregion специальный листенер (c самоидентификацией)
	...
	static public void Broadcast(string eventType, T arg1, U arg2, MessengerMode mode) {
        ...
        MessengerInternalSpecial.OnBroadcasting(eventType, mode);
        var invocationList2 = MessengerInternalSpecial.GetInvocationList<Action<T, U, string>>(eventType); 
        if (invocationList2 != null)//фиксы от Арти
            foreach (var callback in invocationList2)
                callback.Invoke(arg1, arg2, eventType);
    ...
    static public void Broadcast<TReturn>(string eventType, T arg1, U arg2, Action<TReturn> returnCall, MessengerMode mode) {
        ...
        MessengerInternalSpecial.OnBroadcasting(eventType, mode);
        var invocationList2 = MessengerInternalSpecial.GetInvocationList<Func<T, U, string, TReturn>>(eventType);
        if (invocationList2 != null)//фиксы от Арти
            foreach (var result in invocationList2.Select(del => del.Invoke(arg1, arg2, eventType)).Cast<TReturn>())
            {
                returnCall.Invoke(result);
            }
    }
...
static public class Messenger<T, U, V> {
    ...
    static public void AddListener(string eventType, Action<T, U, V, string> handler)
    {
        MessengerInternalSpecial.AddListener(eventType, handler);
    }
    static public void AddListener<TReturn>(string eventType, Func<T, U, V, string, TReturn> handler)
    {
        MessengerInternalSpecial.AddListener(eventType, handler);
    }
    static public void RemoveListener(string eventType, Action<T, U, V, string> handler)
    {
        MessengerInternalSpecial.RemoveListener(eventType, handler);
    }
    static public void RemoveListener<TReturn>(string eventType, Func<T, U, V, string, TReturn> handler)
    {
        MessengerInternalSpecial.RemoveListener(eventType, handler);
    }
    #endregion специальный листенер (c самоидентификацией)
	...
	static public void Broadcast(string eventType, T arg1, U arg2, V arg3, MessengerMode mode) {
        ...
        MessengerInternalSpecial.OnBroadcasting(eventType, mode); 
        var invocationList2 = MessengerInternalSpecial.GetInvocationList<Action<T, U, V, string>>(eventType);
        if (invocationList2 != null)//фиксы от Арти
            foreach (var callback in invocationList2)
                callback.Invoke(arg1, arg2, arg3, eventType);
    }
    ...
    static public void Broadcast<TReturn>(string eventType, T arg1, U arg2, V arg3, Action<TReturn> returnCall, MessengerMode mode)
    {
        ...
        MessengerInternalSpecial.OnBroadcasting(eventType, mode);
        var invocationList2 = MessengerInternalSpecial.GetInvocationList<Func<T, U, V, string, TReturn>>(eventType);
        if (invocationList2 != null)//фиксы от Арти
            foreach (var result in invocationList2.Select(del => del.Invoke(arg1, arg2, arg3, eventType)).Cast<TReturn>())
            {
                returnCall.Invoke(result);
            }
    }
